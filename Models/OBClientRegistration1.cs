...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class OBClientRegistration1 : IEquatable<OBClientRegistration1>
    { 
        /// <summary>
        ...
        /// </summary>
        [JsonConverter(typeof(Newtonsoft.Json.Converters.StringEnumConverter))]
        public enum ListGrantTypesEnum
        {
        ...
        /// </summary>
        [JsonConverter(typeof(Newtonsoft.Json.Converters.StringEnumConverter))]
        public enum ListResponseTypesEnum
        {
        ...
        /// </summary>
        /// <value>Unique identifier for the TPP. Implemented as Base62 encoded GUID</value>
        [Required]
        [DataMember(Name="iss")]
        ...
        /// </summary>
        /// <value>The time at which the request was issued by the TPP  expressed as seconds since 1970-01-01T00:00:00Z as measured in UTC</value>
        [Required]
        [DataMember(Name="iat")]
        ...
        /// </summary>
        /// <value>The time at which the request expires expressed as seconds since 1970-01-01T00:00:00Z as measured in UTC</value>
        [Required]
        [DataMember(Name="exp")]
        ...
        /// </summary>
        /// <value>The audience for the request. This should be the unique identifier for the ASPSP issued by the issuer of the software statement. Implemented as Base62 encoded GUID </value>
        [Required]
        [DataMember(Name="aud")]
        ...
        /// </summary>
        /// <value>Unique identifier for the JWT implemented as UUID v4</value>
        [Required]
        [DataMember(Name="jti")]
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((OBClientRegistration1)obj);
        }

        /// <summary>
        /// Returns true if OBClientRegistration1 instances are equal
        /// </summary>
        /// <param name="other">Instance of OBClientRegistration1 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OBClientRegistration1 other)
        {
        ...
        public static bool operator ==(OBClientRegistration1 left, OBClientRegistration1 right)
        {
